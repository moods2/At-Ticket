...
<body>
    ...
    <div id = "whatsHotPic">
        <div id= "bigPic" >
            <img src="../images/big_Exhibition.jpeg" style = "width : 100%; height : 100%;"alt="">
    ...
    <div id = "atpbanner">
        <div class = "atpPicture" id = "atpOpen1">
            <img src="../images/Exhibition17.jpg" alt="">
        ...
        <div class = "atpPicture" id = "atpOpen4">
            <img src="../images/Exhibition18.jpg" alt="">
        ...
        <div class = "atpPicture" id = "atpOpen6">
            <img src="../images/Exhibition11.jpg" alt="">
