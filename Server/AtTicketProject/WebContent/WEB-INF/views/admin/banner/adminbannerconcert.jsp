   ...
   <!--------------------------- AT'S PICKS 시작------------------------------------------------->
    ...
    <div id = "atpbanner">
        ...
        <div class = "atpPicture" id = "atpOpen2">
            <img src="../images/consert3.jpeg" alt="">
