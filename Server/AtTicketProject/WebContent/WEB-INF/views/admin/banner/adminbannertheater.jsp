...
<body>
   ...
   <!--------------------------- WHAT'S HOT 시작------------------------------------------------->
    ...
    <div id = "whatsHotPic">
        <div id= "bigPic" >
            <img src="../images/big_theater.jpeg" style = "width : 100%; height : 100%;"alt="">
